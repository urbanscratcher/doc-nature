...
[3장](../ch3/10-the-pendulum.md#생태계-프로젝트)에서 만든 생명체를 기반으로 생명체 시스템을 만들어 보세요. 생명체들은 서로 어떻게 상호작용할까요?

상속과 다형성을 사용해 동일한 코드베이스에서 파생된 다양한 생명체를 만들 수 있나요?

자원(예: 식량)을 놓고 생명체들이 경쟁하는 방식을 개발해 보세요.

파티클의 수명 주기처럼 생명체의 건강 상태를 추적하고, 적절한 시기에 생명체를 제거할 수 있을까요? 시스템에 생명체가 태어나는 방식을 제어하는 규칙을 만들 수 있을까요?

또한 생명체 디자인에 파티클 시스템을 사용할 수 있습니다. 방출구를 생명체의 위치에 연결하면 어떻게 될까요?

<img src="https://natureofcode.com/static/14db32daa721654a3e88f7af2fc5f627/2e9c6/04_particles_6.webp" class="img-full" />
